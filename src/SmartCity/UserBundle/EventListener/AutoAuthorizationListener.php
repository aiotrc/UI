...
namespace SmartCity\UserBundle\EventListener;
 ...
 * @package SmartCity\UserBundle\EventListener
...
class AutoAuthorizationListener {
    ...
    private $action_name;
    private $annotationClass = 'SmartCity\\UserBundle\\Annotation\\FrontendAccessible';
    ...
    public function onKernelController(FilterControllerEvent $event)
    {
        ...
        /**
         * @var User $user
         * Handle registered users (panel and frontend)
         */
        $user = $token->getUser();
        if (! $user) {
            throw new AccessDeniedException();
    ...
    /**
     * Checks if a panel have access to the requested action or not
     * This permission is given by the RBAC system
     * @param $event FilterControllerEvent Action request event
     * @return bool whether a panel User have access to the requested action or not
     */
