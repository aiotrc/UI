...
/**
 * SmartCity\UserBundle\Entity\Role
 *
 * @ORM\Table(name="Roles", indexes={@ORM\Index(name="role_index", columns={"role"}) })
 * @ORM\Entity(repositoryClass="SmartCity\UserBundle\Entity\Repository\RoleRepository")
 */
class Role implements RoleInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="SmartCity\UserBundle\Entity\User", mappedBy="roles")
     */
    private $users;

    /**
     * @ORM\ManyToMany(targetEntity="SmartCity\UserBundle\Entity\ActionGroup", inversedBy="roles")
     ...
     * Add users
     *
     * @param \SmartCity\UserBundle\Entity\User $users
     * @return Role
     */
     ...
     * Add actionGroups
     *
     * @param \SmartCity\UserBundle\Entity\ActionGroup $actionGroups
     * @return Role
     */
