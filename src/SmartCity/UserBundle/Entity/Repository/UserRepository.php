...
class UserRepository extends EntityRepository implements UserProviderInterface
{
    ...
    public function isAlreadyExist($username, $email)
    {
        ...
        $qb
            ...
            ->from('SmartCityUserBundle:User', 'u')
     ...
     * @throws \Doctrine\ORM\NonUniqueResultException
     */
    public function isCellphoneExist($cellphone)
    {
    ...
    public function loadUserByUsername($username)
    {
        $q = $this
            ...
            ->select('u, r')
            ->leftJoin('u.roles', 'r')
            ->where('u.username = :username OR u.email = :email OR u.cellphone = :cellphone')
            ->setParameter('username', $username)
            ->setParameter('email', $username)
            ->setParameter('cellphone', '+98'.substr($username,1))
            ->getQuery();
    ...
    public function loadUserByUsernameOrEmail($data)
    {
        ...
        $qb
            ->select('a')
            ->from('SmartCityUserBundle:User', 'a')
    ...
    public function searchForUser($_query)
    {
        ...
        $qb
            ->select(
                'user.id as id',
                'user.email as email',
                'user.email as text', // just for select2 plugin
                'concat(user.firstname , \' \', user.lastname) as fullname'
            )
            ->from('SmartCityUserBundle:User', 'user')
            ->where($qb->expr()->orX(
