...
INSERT INTO `Cities` (`id`, `province_id`, `title`) VALUES
(1, 1, 'آذر شهر'),
(2, 1, 'اسکو'),
(3, 1, 'اهر'),
(4, 1, 'بستان آباد'),
...
UPDATE `Cities` SET active=true, created_at=NOW(), updated_at=NOW();
UPDATE `Provinces` SET active=true, created_at=NOW(), updated_at=NOW();
